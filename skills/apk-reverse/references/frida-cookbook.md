...
> Organized by scenario; copy and use directly.

---

## Generic Hook Templates

### Hooking Any Java Method
...
## Crypto/Signing Hooks

### Hooking AES Encryption/Decryption
...
### Hooking OkHttp3 Requests/Responses
    ...
    Interceptor.attach(fopen, {
        ...
        onLeave: function(retval) {
            if (this.path && this.path.indexOf("/proc/") !== -1 && this.path.indexOf("/status") !== -1) {
                // can go further and hook fgets to patch TracerPid
            }
        }
    });
});
            ...
            try {
                ...
                for (var i = 0; i < dexElements.length; i++) {
                    ...
                    if (dexFile) {
                        ...
                        // can dump the dex contents from here
                    }
                }
            } catch(e) {}
        },
...
| frida-codeshare-scripts | Collection of scripts from across the web | https://github.com/zengfr/frida-codeshare-scripts |
