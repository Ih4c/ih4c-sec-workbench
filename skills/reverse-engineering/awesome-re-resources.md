...
> Curated from multiple awesome lists, sorted by usefulness. AI performing reverse analysis can consult these resources for methodology and tool guidance.

---

## Comprehensive Repositories

| Repository | Stars | Coverage | Link |
|------|-------|------|------|
...
| **Compiler Explorer** | View C/C++/Rust/Go compiled to assembly online | https://godbolt.org/ |

---

## ARM / AArch64 Special Topics

| Resource | Description | Link |
|------|------|------|
| **Official ARM Architecture Manual** | Complete instruction set reference | https://developer.arm.com/documentation |
| **Azeria Labs** | ARM assembly/exploitation tutorials (best starting point) | https://azeria-labs.com/writing-arm-assembly-part-1/ |
...
| **Detect It Easy (DiE)** | File type/packer/compiler detection | https://github.com/horsicq/Detect-It-Easy |
...
| **strace** | Linux syscall tracing | Bundled with the system |
| **ltrace** | Library function call tracing | Bundled with the system |
...
| Resource | Description | Link |
|------|------|------|
| **UPX** | Most common packer — unpack with `upx -d` | https://upx.github.io/ |
| **unipacker** | Generic PE unpacker | https://github.com/unipacker/unipacker |
| **de4dot** | .NET deobfuscator | https://github.com/de4dot/de4dot |
| **JADX** | Android DEX decompiler/deobfuscator | https://github.com/skylot/jadx |
...
3. [Nightmare](https://guyinatuxedo.github.io/) — CTF RE/Pwn tutorial
...
2. [The IDA Pro Book](https://nostarch.com/idapro2.htm) — using IDA in depth
...
| radare2 cheat sheet | this package's `radare2/references/cheatsheet.md` |
