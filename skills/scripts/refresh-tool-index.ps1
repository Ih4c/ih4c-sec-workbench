...
$markdownLines = @(
    ...
    '- Note: this table is auto-generated by `skills/scripts/refresh-tool-index.ps1` for routing and tool-path confirmation by Agent clients.',
    '- Note: tool availability and runtime for MCP-only capabilities are computed separately; `npx` only represents the npm MCP runtime condition and cannot alone make jshookmcp / reqable-mcp available or Ready.',
    '',
