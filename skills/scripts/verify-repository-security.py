...
EXPECTED_PATTERN_HITS = {
    ...
    # deliberate test fixture: re-evaluates its own AST to verify the
    # UTF-8 round-trip survived Windows PowerShell 5.1
    ("skills/scripts/test-bootstrap-codex-encoding.ps1", "dynamic-powershell-eval"),
}
PATTERNS = {
