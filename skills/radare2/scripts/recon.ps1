...
# Force UTF-8 output for this script to minimize mojibake in section headings.
...
function Write-Section {
    ...
    # Fixed section headings: readable by humans and greppable downstream.
    ""
    "=== $Title ==="
}
...
# Normalize the input path to an absolute path so r2/rabin2 do not resolve it ambiguously relative to the CWD.
...
if ($RunAnalysis) {
    Write-Section -Title 'Functions and entry point analysis'
